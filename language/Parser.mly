...
| L_SQ hd = list_element tl = list_tail R_SQ {
...
list_tail:
|                                          { [] }
| SEMICOLON e = simple_expr tl = list_tail { e :: tl }


app_expr:
| f = simple_expr rest = app_args {
    List.fold_left (fun acc arg -> App(acc, arg, Annotation.create $loc)) f rest 
}

app_args:
|                                   { [] }
| e = simple_expr rest = app_args   { e :: rest }
